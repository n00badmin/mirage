...
function mirage_draw_navigation_text ($nav) {
	$nav['mirage.php:'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'mirage.php', 'level' => '1');
	$nav['mirage.php:save'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'mirage.php', 'level' => '1');
	$nav['mirage.php:autocreate'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'mirage.php', 'level' => '1');
	$nav['listmirage.php:'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'listmirage.php', 'level' => '1');
	$nav['listmirage.php:actions'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'listmirage.php', 'level' => '1');
	$nav['mirage_graph.php:'] = array('title' => 'Thresholds', 'mapping' => 'index.php:', 'url' => 'mirage_graph.php', 'level' => '1');
	$nav['mirage_view_failures.php:'] = array('title' => 'Thresholds - Failures', 'mapping' => 'index.php:', 'url' => 'mirage_view_failures.php', 'level' => '1');
	$nav['mirage_view_normal.php:'] = array('title' => 'Thresholds - Normal', 'mapping' => 'index.php:', 'url' => 'mirage_view_normal.php', 'level' => '1');
	$nav['mirage_view_recover.php:'] = array('title' => 'Thresholds - Recovering', 'mapping' => 'index.php:', 'url' => 'mirage_view_recover.php', 'level' => '1');
	$nav['mirage_view_recent.php:'] = array('title' => 'Recent Thresholds', 'mapping' => 'index.php:', 'url' => 'mirage_view_recent.php', 'level' => '1');
	$nav['mirage_view_host.php:'] = array('title' => 'Recent Host Failures', 'mapping' => 'index.php:', 'url' => 'mirage_view_host.php', 'level' => '1');

	$nav['mirage_templates.php:'] = array('title' => 'Threshold Templates', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '1');
	$nav['mirage_templates.php:edit'] = array('title' => 'Threshold Templates', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '1');
	$nav['mirage_templates.php:save'] = array('title' => 'Threshold Templates', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '1');
	$nav['mirage_templates.php:add'] = array('title' => 'Threshold Templates', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '1');
	$nav['mirage_templates.php:actions'] = array('title' => 'Threshold Templates', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '1');
	$nav['mirage_templates.php:import'] = array('title' => 'Threshold Template Import', 'mapping' => 'index.php:', 'url' => 'mirage_templates.php', 'level' => '2');

	$nav['mirage_add.php:'] = array('title' => 'Create Threshold', 'mapping' => 'index.php:', 'url' => 'mirage_add.php', 'level' => '1');
...
function mirage_config_insert () {
	global $menu;

	$menu['Management']['plugins/mirage/notify_lists.php'] = 'Notification Lists';
	$menu['Management']['plugins/mirage/listmirage.php'] = 'Thresholds';
	$menu['Templates']['plugins/mirage/mirage_templates.php'] = 'Threshold Templates';
	if (isset($_GET['mirage_vrule'])) {
		if ($_GET['mirage_vrule'] == 'on') {
			$_SESSION['sess_config_array']['mirage_draw_vrules'] = 'on';
			$_SESSION['sess_config_array']['boost_png_cache_enable'] = false;
		} elseif ($_GET['mirage_vrule'] == 'off') {
			$_SESSION['sess_config_array']['mirage_draw_vrules'] = 'off';
		}
	}
...
function mirage_config_arrays () {
	global $messages;
	$messages['mirage_save'] = array(
		'message' => 'A template with that Data Source already exists!',
		'type' => 'error');
	if (isset($_SESSION['mirage_message']) && $_SESSION['mirage_message'] != '') {
		$messages['mirage_created'] = array('message' => $_SESSION['mirage_message'], 'type' => 'info');
	}
}

function mirage_config_form () {
...
function mirage_config_settings () {
	...
	$settings['mirage'] = array(
		...
		'mirage_out_file_format' => array(
			'friendly_name' => 'Output file format',
		...
		'mirage_alerting_header' => array(
			'friendly_name' => 'Default Alerting Options',
			'method' => 'spacer',
			),
		'alert_exempt' => array(
			'friendly_name' => 'Weekend exemptions',
			'description' => 'If this is checked, mirage will not run on weekends.',
			'method' => 'checkbox',
			),
		'alert_trigger' => array(
		...
		'mirage_email_header' => array(
			'friendly_name' => 'Emailing Options',
			'method' => 'spacer',
			),
		'mirage_email_prio' => array(
